...
export class PaymentList implements OnInit {
  ...
  openCreateDialog(): void {
    const ref = this.dialog.open(PaymentCreateDialog, { width: '560px' });
...
@Component({
  ...
  `,
  styles: [`
    .dialog-form { display: flex; flex-direction: column; gap: 6px; min-width: 440px; }
...
@Component({
  ...
  `,
  styles: [`
    .dialog-form { display: flex; flex-direction: column; gap: 4px; min-width: 400px; margin-top: 12px; }
