...
export const selectPropertyLoading = createSelector(selectPropertyState, (state) => state.loading);

export const selectPropertyError = createSelector(selectPropertyState, (state) => state.error);
