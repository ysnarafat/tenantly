...
CREATE INDEX IF NOT EXISTS idx_shops_property_active ON shops(property_id, active);
CREATE INDEX IF NOT EXISTS idx_shops_floor_section ON shops(floor, section) WHERE floor IS NOT NULL AND section IS NOT NULL;
...
CREATE INDEX IF NOT EXISTS idx_leases_shop_active ON leases(shop_id, active);
